...
from api import deps as deps_api, jobs as jobs_api, staging as staging_api
from core import config as config_mod
from core.db import job_history as db_job_history, ledger as db_ledger, queue_items as db_queue_items, stats as db_stats
...
from tests.conftest import (
    ...
    _make_upload_request_service_capture,
    _make_upload_service_stub,
    _run_async,
...
def test_upload_service_passes_target_paths_to_processing_run_job():
    ...
    with patch("logic.jobs.executors.runner.run_job", side_effect=fake_run_job):
        with patch("logic.jobs.engine.threading.Thread", ImmediateThread):
            with patch("logic.jobs.engine.db_job_history.save_job_history"):
